(function($) {
    ...
    $.extend(Plugin.prototype, {
        ...
        desktopNotifications: function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    that.desktopNotificationsInterval = setInterval(function() {
                        that.desktopNotificationsCheck()
                    }, that.settings.desktopNotificationsAJAXInterval);
                },
            ...
            attachmentInput.on('change', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(data, textStatus, jqXHR) {
                        ...
                        that.liveChatWatchCommentsInterval = setInterval(function() {
                            that.liveChatWatchComments()
                        }, that.settings.liveChatAJAXInterval);
                    },
                    error: function(jqXHR, textStatus, errorThrown) {
                        $('.wordpress-helpdesk-livechat-comment-form-attachment').find('.fa').addClass('fa-paperclip').removeClass('fa-spinner fa-spin');
                        console.log(jqXHR);
        ...
        liveChatRenderChatMessages: function(messages) {
            ...
            $('#wordpress-helpdesk-livechat-messages').animate({
                scrollTop: $('#wordpress-helpdesk-livechat-messages').prop("scrollHeight")
            }, 1000);
        },
